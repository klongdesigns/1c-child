...
function mytheme_add_admin() {
	...
	add_menu_page('Theme Settings', 'Theme Settings', 'administrator', basename(__FILE__), 'mytheme_admin',get_bloginfo('stylesheet_directory')."/1call/images/themeLogo.png",7);
}
